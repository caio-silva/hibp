...
class HaveIBeenPwndApiExceptionsTest {
    ...
    private final HaveIBeenPwndApi noAPIKeyUnderTest = HaveIBeenPwndBuilder.create().withUserAgent( "something" ).addPadding( true ).build();

    @Nested
    class GetAllBreachesForAccount {
        @Test
        void getAllBreachesForAccountThrowsNoAPIKeyProvidedException( ) throws HaveIBeenPwndException {
            assertThrows(
                    HaveIBeenPwndException.NoAPIKeyProvidedException.class, ( ) -> noAPIKeyUnderTest.getAllBreachesForAccount( "adobe" ) );
        }
    }
    ...
    class GetBreachByName {
        ...
        void getBreachByNameThrowsNotFoundException( ) throws HaveIBeenPwndException {
            assertThrows(
                    HaveIBeenPwndException.NotFoundException.class, ( ) -> noAPIKeyUnderTest.getBreachByName( "fanduel" ) );
        }
    }
    ...
    class GetAllPastesForAccount {
        ...
        void getAllPastesForAccountThrowsNoAPIKeyProvidedException( ) {
            assertThrows(
                    HaveIBeenPwndException.NoAPIKeyProvidedException.class, ( ) -> noAPIKeyUnderTest.getAllPastesForAccount( "adobe" ) );
        }
    }
    ...
    class IsAccountPwned {
        ...
        void isAccountPwnedThrows( ) throws HaveIBeenPwndException {
            assertThrows(
                    HaveIBeenPwndException.NoAPIKeyProvidedException.class, ( ) -> noAPIKeyUnderTest.isAccountPwned( "adobe" ) );
        }
    }
    ...
    class IsPlainPasswordPwned {
        ...
        void isPlainPasswordPwnedFalse( ) throws HaveIBeenPwndException, IOException {
            boolean password = noAPIKeyUnderTest.isPlainPasswordPwned( PWND_PASSWORD + UUID.randomUUID() );
    ...
    class IsHashPasswordPwned {
        ...
        void isHashPasswordPwnedTrue( ) throws HaveIBeenPwndException, IOException {
            boolean password = noAPIKeyUnderTest.isHashPasswordPwned(
    ...
    class ValidateAPIKey {
        ...
        void validateAPIKeyThrowsNoAPIKeyProvidedException( ) {
            assertThrows(
                    HaveIBeenPwndException.NoAPIKeyProvidedException.class, noAPIKeyUnderTest::validateAPIKey );
        }
    }
}
