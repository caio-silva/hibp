...
public class HaveIBeenPwndApi implements HaveIBeenPwndAPI {
    ...
    protected HaveIBeenPwndApi(
        ...
        this.rateLimiterHttpCallExecutor =
                new RateLimiterHttpCallExecutor(hibpService, rateLimiterEntity);
    }
    ...
    private List<Breach> getAllBreachesForAccount(
        ...
        validateAPIKey();
        return rateLimiterHttpCallExecutor.getAllBreachesForAccount(
                account, domain, truncateResponse, includeUnverified);
    }
    ...
    public List<Paste> getAllPastesForAccount(String account) throws HaveIBeenPwndException {
        validateAPIKey();
        return rateLimiterHttpCallExecutor.getAllPastesForAccount(account);
    }
    ...
    public boolean isHashPasswordPwned(String pwHash) throws HaveIBeenPwndException {
        ...
        List<PwnedHash> hashes =
                searchByRange(hash5).stream()
