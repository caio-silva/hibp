...
public interface HIBPHttpClient {
    ...
    Call<List<Object>> getAllBreachesForAccount(
                                                 @Header( "hibp-api-key" ) String apiKey, @Path( value = "account" ) String account, @Query( "includeUnverified" ) boolean includeUnverified, @Query( "truncateResponse" ) boolean truncateResponse, @Query( "domain" ) String domain );
    ...
    Call<List<Object>> getAllPastesForAccount(
