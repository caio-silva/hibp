...
public class HaveIBeenPwndException extends Exception {
	...
	public static class BadRequestException extends HaveIBeenPwndException {
		private static final String DEFAULT_MESSAGE = "Bad request — the account does not comply with an acceptable format (i.e. it's an" + " empty string)";
	...
	public static class UnauthorizedException extends HaveIBeenPwndException {
		private static final String DEFAULT_MESSAGE = "Unauthorised — the API key provided was not valid";
	...
	public static class ForbiddenException extends HaveIBeenPwndException {
		private static final String DEFAULT_MESSAGE = "Forbidden — no user agent has been specified in the request";
	...
	public static class TooManyRequestsException extends HaveIBeenPwndException {
		private static final String DEFAULT_MESSAGE = "Too many requests — the rate limit has been exceeded";
	...
	public static class UnknownErrorCodeException extends HaveIBeenPwndException {
		public UnknownErrorCodeException( String errorMsg ) {
			super( errorMsg );
		}
	}
}
